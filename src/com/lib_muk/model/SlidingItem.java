...
public class SlidingItem implements Serializable{
	...
	public static final SlidingItem sliding_download=new SlidingItem(3,R.drawable.sliding_download_icon,"下载");
	public static final SlidingItem sliding_setting=new SlidingItem(4,R.drawable.sliding_setting_icon,"设置");
